...
(function (window, document) {
    ...
    var maxDiffX = 40; // max number of X pixels the mouse can move during long press before it is canceled
    var maxDiffY = 40; // max number of Y pixels the mouse can move during long press before it is canceled
